...
import com.rd.zxing.Contents;
import com.rd.zxing.LocaleManager;
...
//  }
  ...
  final void launchIntent(Intent intent) {
    try {
      ...
      builder.setPositiveButton(R.string.msg_alert_yes, null);
      builder.show();
    }
  }
  ...
  private String parseCustomSearchURL() {
    ...
    String customProductSearch = prefs.getString(PerferenceKey.KEY_CUSTOM_PRODUCT_SEARCH,
        null);
