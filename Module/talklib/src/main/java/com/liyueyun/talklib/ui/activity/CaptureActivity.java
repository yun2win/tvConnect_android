package com.liyueyun.talklib.ui.activity;
...
import com.rd.zxing.AmbientLightManager;
import com.rd.zxing.BeepManager;
import com.rd.zxing.CaptureActivityHandler;
import com.rd.zxing.DecodeFormatManager;
import com.rd.zxing.DecodeHintManager;
import com.rd.zxing.FinishListener;
import com.rd.zxing.InactivityTimer;
import com.rd.zxing.IntentSource;
import com.rd.zxing.Intents;
import com.rd.zxing.PerferenceKey;
import com.rd.zxing.ScanFromWebPageManager;
import com.rd.zxing.ViewfinderView;
import com.rd.zxing.camera.CameraManager;
import com.rd.zxing.clipboard.ClipboardInterface;
import com.rd.zxing.result.ResultHandler;
...
public final class CaptureActivity extends Activity implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        final String code = getIntent().getStringExtra("codeInfo");
    ...
    protected void onResume() {
        ...
        copyToClipboard = prefs.getBoolean(PerferenceKey.KEY_COPY_TO_CLIPBOARD,
                true)
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        // if (fromLiveScan && prefs.getBoolean(PerferenceKey.KEY_BULK_MODE,
        // false)) {
    ...
    private void handleDecodeInternally(Result rawResult,
        ...
        if (resultHandler.getDefaultButtonID() != null
                && prefs.getBoolean(PerferenceKey.KEY_AUTO_OPEN_WEB, false)) {
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setMessage("抱歉，Android相机出现问题。您可能禁用了此权限，可在权限管理中打开。");
        builder.setPositiveButton("确定", new FinishListener(
                this));
